...
class GoogleBusinessProfile extends HTMLElement {
    ...
    displayBusinessProfile() {
      ...
      // Populate data
      this.shadowRoot.getElementById('business-name').innerText = this.businessData.name || 'N/A';
      this.shadowRoot.getElementById('business-category').innerText = this.businessData.primaryCategory?.displayName || 'N/A';
      this.shadowRoot.getElementById('account-number').innerText = this.businessData.name || 'N/A'; // Adjust based on actual data
      this.shadowRoot.getElementById('business-type').innerText = this.businessData.type || 'N/A';
