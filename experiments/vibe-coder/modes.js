export const MODES = [
  {
    ...
    description:
      "Expert in building standalone web components with clean APIs.",
    icon: "fas fa-cubes",
...
Return JUST the javascript in markdown. Do not include any explanation outside the code block.`,
  ...
  },
  {
    ...
    description:
      "Control and modify existing web components on the canvas using natural language.",
    icon: "fas fa-gamepad",
    systemPrompt:
...
Focus on modern aesthetics: glassmorphism, gradients, smooth transitions, and responsive design.`,
  ...
  },
  {
    ...
    title: "Logic Wizard",
    description:
      "Expert in complex state management and component interactions.",
    icon: "fas fa-bolt",
    disabled: true,
