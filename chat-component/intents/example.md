---
name: chat_component_help
description: Provides documentation and help for the Chat Component, including installation, customization, and memory system details.
...
## Examples
- How do I install the chat component?
- What are the available attributes for customization?
- How does the semantic memory system work?
- Can this run without a server?
- What features does the chat component have?
